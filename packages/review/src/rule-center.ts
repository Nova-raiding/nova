...
export const defaultRuleCenterSeeds: readonly RuleCenterSeed[] = [
  { packId: 'cn-commerce', name: '中国电商广告表达', version: 'cn-commerce-1.0.0', scope: 'global', status: 'active', source: { kind: 'internal', reference: 'manual://cn-commerce-advertising', checkedAt: '2026-08-22T00:00:00.000Z' }, checks: { forbiddenTerms: ['最强', '第一', '绝对化'] }, createdAt: '2026-08-22T00:00:00.000Z' },
  ...
  { packId: 'tmall-mapping', name: '淘宝/天猫字段映射', version: 'tmall-apparel-1.0.0', scope: 'platform', targetId: 'tmall', status: 'active', source: { kind: 'internal', reference: 'manual://tmall-mapping', checkedAt: '2026-08-17T00:00:00.000Z' }, createdAt: '2026-08-17T00:00:00.000Z' },
  { packId: 'taobao-mapping', name: '淘宝字段映射', version: 'taobao-apparel-1.0.0', scope: 'platform', targetId: 'taobao', status: 'active', source: { kind: 'internal', reference: 'manual://taobao-mapping', checkedAt: '2026-08-17T00:00:00.000Z' }, createdAt: '2026-08-17T00:00:00.000Z' },
  { packId: 'jd-write', name: '京东商品写入策略', version: 'jd-apparel-write-1.0.0', scope: 'platform', targetId: 'jd', status: 'active', source: { kind: 'internal', reference: 'manual://jd-write', checkedAt: '2026-08-15T00:00:00.000Z' }, createdAt: '2026-08-15T00:00:00.000Z' },
  { packId: 'pinduoduo-mapping', name: '拼多多字段映射', version: 'pinduoduo-apparel-1.0.0', scope: 'platform', targetId: 'pinduoduo', status: 'active', source: { kind: 'internal', reference: 'manual://pinduoduo-mapping', checkedAt: '2026-08-16T00:00:00.000Z' }, createdAt: '2026-08-16T00:00:00.000Z' },

...
export const MCP_METHOD_CONTRACTS: readonly McpMethodContract[] = [
  ...
  },
  {
    ...
    description: 'Search catalog products. Store scope requires platform + account_id; workspace aggregation must be explicit with scope=workspace. The result also includes per-product next actions for store binding or fact confirmation. Set include_knowledge=true to attach bounded, approved workspace rules and knowledge assets for the selected product context.',

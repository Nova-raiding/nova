...
const tenantRead: readonly CapabilityId[] = [
  'workspace.summary.read', 'workspace.member.read', 'billing.self.read',
...
export const ROLE_CAPABILITIES: Readonly<Record<CanonicalRole, readonly CapabilityId[]>> = {
  ...
  workspace_owner: [...tenantOperate, 'store.connection.update', 'workspace.member.manage', 'workspace.status.update', 'workspace.delete.execute', 'billing.workspace.read', 'billing.workspace.update', 'billing.refund.execute', 'billing.export', 'commercial.update'],
  workspace_admin: [...tenantOperate, 'store.connection.update', 'workspace.member.manage', 'workspace.delete.execute', 'billing.workspace.read', 'billing.workspace.update', 'billing.refund.execute', 'billing.export', 'commercial.update'],
...
const POLICY_GROUPS: readonly PolicyGroup[] = [
  ...
  read('workspace.delete.execute', 'workspace', 'customer_content', ['workspace.data.export.get']),
  write('workspace.delete.execute', 'workspace', 'customer_content', ['workspace.data.export.request'], 'mutation', ['reason', 'idempotency']),
  ...
  read('billing.workspace.read', 'workspace', 'finance', ['billing.reconciliation', 'billing.model-usage.statement', 'commercial.access.get', 'commercial.catalog.get', 'commercial.order.payment.get', 'creative-points.balance.get', 'creative-points.statement.list']),
  ...
  read('customer.content.read', 'workspace', 'customer_content', ['brand-unit.list', 'brand-unit.listing.list', 'canonical.product.consistency', 'campaign.batch.list', 'campaign.batch.get', 'catalog.search', 'catalog.categories', 'rule.list', 'rule.sync.status', 'rule.history', 'asset.list', 'brand.get', 'catalog.sync.get', 'deliverable.list', 'task.history', 'feedback.list', 'creative.directions', 'publish.batch.get', 'knowledge.rule.list', 'knowledge.asset.list', 'knowledge.learning.list', 'knowledge.competitor.list', 'multimodal.video.get', 'catalog.image.get']),

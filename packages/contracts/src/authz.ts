...
const POLICY_GROUPS: readonly PolicyGroup[] = [
  ...
  read('billing.workspace.read', 'workspace', 'finance', ['billing.reconciliation', 'billing.model-usage.statement', 'commercial.access.get', 'commercial.catalog.get', 'creative-points.balance.get', 'creative-points.statement.list']),

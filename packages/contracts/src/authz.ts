...
const POLICY_GROUPS: readonly PolicyGroup[] = [
  ...
  write('customer.publish.execute', 'workspace', 'customer_content', ['content.export', 'publish.prepare', 'publish.batch.prepare', 'publish.batch.pause', 'publish.batch.resume', 'publish.batch.retry_failed', 'delivery.bundle.verify'], 'allow_and_deny'),
  write('customer.publish.execute', 'brand', 'customer_content', ['content.approve'], 'allow_and_deny'),

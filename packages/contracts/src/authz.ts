...
const POLICY_GROUPS: readonly PolicyGroup[] = [
  ...
  read('customer.content.read', 'brand', 'customer_content', ['generation.get', 'publish.get', 'publish.manual.get', 'publish.manual.list', 'task.timeline', 'content.versions', 'content.diff', 'creative.brief', 'creative.preview']),

...
const POLICY_GROUPS: readonly PolicyGroup[] = [
  ...
  // The endpoint returns redacted platform-owned readiness/cost metadata. Keep
  // it in the platform workbench so the operations console can read the same

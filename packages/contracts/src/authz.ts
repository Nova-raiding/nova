...
export const ROLE_CAPABILITIES: Readonly<Record<CanonicalRole, readonly CapabilityId[]>> = {
  ...
  ops_admin: [...platformRead, 'authorization.role.read', 'authorization.grant.read', 'authorization.grant.manage', 'identity.read', 'identity.update', 'identity.session.revoke', 'workspace.delete.execute', 'workspace.member.read', 'workspace.member.manage', 'support.ticket.update', 'support.customer.export', 'incident.update', 'incident.administer', 'feature_flag.update', 'commercial.update', 'commercial.export', 'platform.settings.update', 'platform.media_spec.update', 'platform.media_spec.approve', 'billing.platform.read', 'billing.reconcile.execute', 'billing.export', 'canonical.backfill.read', 'canonical.backfill.update', 'marketing.alert.update', 'store.connection.update'],
  support_agent: ['platform.summary.read', 'workspace.directory.read', 'support.ticket.read', 'support.ticket.update', 'support.customer.export', 'incident.read', 'incident.update', 'audit.read', 'feature_flag.read'],
  ...
  workspace_support: [...tenantRead, 'support.ticket.read', 'support.ticket.update', 'incident.read', 'marketing.queue.read', 'billing.export'],
...
const POLICY_GROUPS: readonly PolicyGroup[] = [
  ...
  read('support.ticket.read', 'workspace', 'customer_metadata', ['ops.support.tickets.list', 'ops.support.ticket.get']),
  ...
  write('store.connection.update', 'workspace', 'customer_metadata', ['platform.connect', 'platform.revoke', 'platform.store.alias.set']),
  read('customer.content.read', 'workspace', 'customer_content', ['brand-unit.list', 'brand-unit.listing.list', 'canonical.product.consistency', 'campaign.batch.list', 'campaign.batch.get', 'catalog.search', 'catalog.categories', 'catalog.image.get', 'rule.list', 'rule.sync.status', 'rule.history', 'asset.list', 'brand.get', 'catalog.sync.get', 'deliverable.list', 'task.history', 'task.timeline', 'feedback.list', 'creative.directions', 'creative.brief', 'creative.preview', 'generation.get', 'content.versions', 'content.diff', 'publish.batch.get', 'publish.get', 'knowledge.rule.list', 'knowledge.asset.list', 'knowledge.learning.list', 'knowledge.competitor.list', 'multimodal.video.get']),
  write('customer.content.update', 'workspace', 'customer_content', ['brand-unit.create', 'brand-unit.bind-store', 'brand-unit.product.create', 'brand-unit.listing.create', 'brand-unit.access.grant', 'campaign.batch.create', 'campaign.batch.generate', 'campaign.batch.pause', 'campaign.batch.resume', 'campaign.batch.retry_failed', 'catalog.title.optimize', 'catalog.title.accept', 'catalog.import', 'catalog.import.batch', 'catalog.sku.update', 'catalog.product.update', 'catalog.facts.confirm', 'catalog.product.disable', 'catalog.product.enable', 'catalog.image.generate', 'catalog.image.select', 'catalog.image.review', 'sync.retry_failed', 'asset.parse', 'asset.facts.confirm', 'asset.preference.update', 'brand.extract', 'brand.upsert', 'brand.tone.preview', 'asset.upload', 'asset.upload.batch', 'asset.scan', 'asset.generation.confirm', 'asset.rights.update', 'catalog.sync', 'catalog.sync.start', 'task.create', 'task.answer', 'task.understand', 'task.request.create', 'task.sku.split', 'task.group.create', 'task.resume', 'task.clone', 'creative.directions.update', 'task.select_direction', 'task.plan.confirm', 'content.generate', 'content.codex.prepare', 'content.codex.commit', 'content.review', 'content.review.decide', 'content.visual.select', 'content.modify', 'content.restore', 'ops.marketing.generation.retry', 'knowledge.rule.create', 'knowledge.asset.create', 'knowledge.asset.update', 'knowledge.feedback.record', 'knowledge.learning.confirm', 'knowledge.learning.dismiss', 'knowledge.competitor.create', 'knowledge.competitor.reference', 'multimodal.image.edit', 'multimodal.generate', 'multimodal.video.request']),

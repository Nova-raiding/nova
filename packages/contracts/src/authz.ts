...
const POLICY_GROUPS: readonly PolicyGroup[] = [
  ...
  write('customer.delivery.update', 'platform', 'customer_metadata', ['ops.customer-delivery.create', 'ops.customer-delivery.videos.add', 'ops.customer-delivery.assets.upload']),

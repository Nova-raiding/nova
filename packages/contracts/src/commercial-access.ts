...
export const COMMERCIAL_MCP_FOUNDATION_POLICIES = defineCommercialOperationRegistry([
  ...
  { surface: 'MCP', operation: 'workspace.data.export.request', domain: 'COMMERCIAL', enabled: true, classification: 'RECOVERY_CONTROL', rate_action: null },
  { surface: 'MCP', operation: 'workspace.data.export.get', domain: 'COMMERCIAL', enabled: true, classification: 'RECOVERY_CONTROL', rate_action: null },
  ...
  { surface: 'MCP', operation: 'content.draft.generate', domain: 'COMMERCIAL', enabled: true, classification: 'POINT_CHARGED', rate_action: 'text.generate' },
...
export const COMMERCIAL_ACCESS_ERROR_CODES = [
  ...
  ERROR_CODES.COMMERCIAL_ENTITLEMENT_REQUIRED,
  ERROR_CODES.COMMERCIAL_ENTITLEMENT_AMBIGUOUS,
] as const

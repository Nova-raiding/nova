...
export const profiles = { jd: jdProfile, taobao: taobaoProfile, tmall: tmallProfile, pinduoduo: pinduoduoProfile, xiaohongshu: xiaohongshuProfile, douyin: douyinProfile };
export function createFakeConnector(platform, options) {
    return new FakePlatformConnector(profiles[platform], options);
}
export function createConfiguredConnector(platform, options) {

-- Older installs retained the pluralized legacy state constraint name; remove
-- it before installing the provider reservation state fence.
ALTER TABLE image_generation_executions
  DROP CONSTRAINT IF EXISTS image_generation_executions_state_check;
ALTER TABLE image_generation_executions

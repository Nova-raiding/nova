...
export async function loadMigrations(): Promise<Migration[]> {
  ...
  const interactiveConfirmationTicketReservations = await readFile(new URL('./migrations/138_interactive_confirmation_ticket_reservations.sql', import.meta.url), 'utf8')
  return [
    initial,
    ...
    { version: 138, name: 'interactive_confirmation_ticket_reservations', sql: interactiveConfirmationTicketReservations },
  ]
}

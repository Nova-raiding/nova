...
import type { FetchLike, ConnectorBeforeRequest } from '../../../packages/connectors/src/http-connector.js'
...
export class ConnectorRuntime {
  ...
  constructor(options: { fixtureMode?: boolean; allowFixtureWrites?: boolean; connectorConfigs?: Partial<Record<Platform, HttpConnectorConfig>>; configSource?: ConfigSource; capabilityEvidenceTrust?: ProductionCapabilityEvidenceTrust; structuredConfig?: Partial<Record<Platform, StructuredPlatformConfig>>; credentialProvider?: CredentialProvider; fetch?: FetchLike; beforeRequest?: ConnectorBeforeRequest; mappingPreflight?: ConnectorRuntimeMappingPreflightAdapter; environment?: 'development' | 'test' | 'production' } = {}) {
    ...
    this.connectors = Object.fromEntries((Object.keys(profiles) as Platform[]).map(platform => {
      ...
      return [platform, config
        ? createConfiguredConnector(platform, { config, credentials: options.credentialProvider, fetch: options.fetch, beforeRequest: options.beforeRequest })

...
export IMAGE_MODEL=${IMAGE_MODEL:-qwen-image-2.0}
export IMAGE_EDIT_MODEL=${IMAGE_EDIT_MODEL:-qwen-image-2.0}
...
export MODEL_RELAY_COST_EVIDENCE=${MODEL_RELAY_COST_EVIDENCE:-true}
export MODEL_RELAY_PRICING_DERIVATION_ENABLED=${MODEL_RELAY_PRICING_DERIVATION_ENABLED:-true}
export MODEL_RELAY_PRICING_GROUP=${MODEL_RELAY_PRICING_GROUP:-VIP}

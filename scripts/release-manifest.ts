...
export function buildReleaseManifest(input: {
  ...
  const artifactPaths = [
    ...
    resolve(root, 'infra/scripts/launch-ecs-candidate-full-https-gateway.mjs'),
    resolve(root, 'infra/scripts/launch-ecs-candidate-full-https-gateway.d.mts'),
    ...
    resolve(root, 'docs/runbooks/ecs-release-evidence-bundle-attester.md'),
    resolve(root, 'docs/runbooks/ecs-candidate-safe-sync.md'),

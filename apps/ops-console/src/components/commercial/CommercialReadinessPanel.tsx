...
const displayName: Record<string, string> = { image: "标准图片", image_edit: "图片标注 / 编辑", video: "15 秒视频", text: "文本生成", ocr: "图片文字识别" };

...
export function createIsolatedPostgresConfig(environment: NodeJS.ProcessEnv) {
  ...
  if (!valid || ISOLATED_POSTGRES_TEST_FILES.length !== 15 || ALL_POSTGRES_TEST_FILES.length < ISOLATED_POSTGRES_TEST_FILES.length) throw new Error('Use the isolated PostgreSQL launcher; generated local fixture bindings and the PostgreSQL manifest are required.')

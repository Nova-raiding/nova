...
| 部署前退款协商、验收后 5000 不退 | generic refund/approval foundation | 无商业订单状态绑定的退款证据 | ❌ |
| 月费剩余点数退款、点包有效期 | refund/reversal/lifecycle foundation | 商业政策未落地；点包未启用 | 🟡 |
...
1. 批准并启用 5000 元正式版、1999 元试用、三档月费和两个点包。

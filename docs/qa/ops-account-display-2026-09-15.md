...
最新补充（2026-09-15 10:20）：修复 OAuth 防护误拒正常 workspace OIDC 会话后，owner 冻结版本的两个登录展示、工作台隔离和客服只读交付共 4 项真实桌面验收全部通过；真实 PKCE 商家 token 仍不能访问 ops.session。详情与发布边界见 [最新整合记录](ops-delivery-readonly-2026-09-15.md)，未部署本轮 API／UI 修改。

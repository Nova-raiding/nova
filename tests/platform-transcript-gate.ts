...
const required = ['exchange_code', 'sync_products', 'create_product', 'update_product', 'query_write', 'upload_media', 'revoke']
const capabilityOperation: Record<string, string> = { authorize: 'exchange_code', read: 'sync_products', full_sync: 'sync_products', incremental_sync: 'sync_products', create: 'create_product', update: 'update_product', query_status: 'query_write', revoke: 'revoke', media_upload: 'upload_media' }

...
describe('video cost preflight contract', () => {
  it('guards both rendering entrypoints before wallet debit and provider execution', () => {
    ...
    expect(dedicatedRoute.indexOf('await requireVideoModelCostPreflight()')).toBeLessThan(dedicatedRoute.indexOf('await debitPluginWallet'))

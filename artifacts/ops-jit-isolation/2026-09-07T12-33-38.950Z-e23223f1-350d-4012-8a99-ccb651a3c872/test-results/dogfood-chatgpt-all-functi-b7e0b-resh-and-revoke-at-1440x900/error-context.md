      ...
      - generic [ref=e90]:
        ...
        - region "当前身份与权限范围" [ref=e95]:
          - generic [ref=e96]:
            ...
            - generic [ref=e107]: 身份 ops-fixture-actor-9af048c6-d817-443f-91f5-a73b3cf80b37
        ...
        - generic [ref=e148]:
          - alert [ref=e151]:
            ...
            - generic [ref=e156]:
              ...
              - paragraph [ref=e160]: 部分数据集刷新失败（ops.stores.list、ops.storage.reconciliation.list、ops.brand-units.summary、ops.audit.platform.list、ops.tasks.summary、ops.marketing.summary、ops.growth.funnel、ops.alerts.list、ops.workspaces.list）。页面保留上次成功数据，这些值可能已过期：当前账号没有访问部分运营数据的权限；请切换具备对应角色的运营账号。

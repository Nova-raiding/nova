    ...
    - generic [ref=e8]:
      ...
      - region "当前操作范围" [ref=e15]:
        - generic [ref=e16]:
          ...
          - generic [ref=e18]: 工作区
        - status [ref=e19]: 正在操作工作区 ws_ops_fixture_a76d7c175b0c48319fcc5bb986160d2b
        - generic [ref=e20]:
          - generic [ref=e21]: 工作区范围
          - strong [ref=e22]: ws_ops_fixture_a76d7c175b0c48319fcc5bb986160d2b
      ...
      - generic [ref=e74]:
        ...
        - region "当前身份与权限范围" [ref=e79]:
          - generic [ref=e80]:
            ...
            - generic [ref=e91]: 身份 ops-fixture-target-a76d7c17-5b0c-4831-9fcc-5bb986160d2b
            - generic [ref=e93]: 商家工作区
            - generic [ref=e95]: 工作区 · ws_ops_fixture_a76d7c175b0c48319fcc5bb986160d2b
    ...
    - main [ref=e103]:
      ...
      - status [ref=e105]:
        ...
        - generic [ref=e110]:
          ...
          - generic [ref=e112]: 部分数据集刷新失败（workspace.commercial.get、billing.model-usage.statement、workspace.metrics、knowledge.asset.list、knowledge.rule.list、knowledge.learning.list、knowledge.brand.preference.get、knowledge.competitor.list、automation.policy.get、automation.policy.list）。页面保留上次成功数据，这些值可能已过期：商业操作尚未满足上线门禁，已拒绝执行
      - generic [ref=e113]:
        - img "Unauthorized" [ref=e115]
        - heading "无权访问“客服”" [active] [level=1] [ref=e170]
        - generic [ref=e172]: 当前会话在workspace:ws_ops_fixture_a76d7c175b0c48319fcc5bb986160d2b范围内缺少 support.ticket.read 能力；服务端仍会独立校验每个请求。
        - generic [ref=e174]:
        ...
        - alert "权限拒绝详情" [ref=e185]:
          ...
          - generic [ref=e190]:
            - text: 当前范围：
            - code [ref=e192]: workspace:ws_ops_fixture_a76d7c175b0c48319fcc5bb986160d2b
```
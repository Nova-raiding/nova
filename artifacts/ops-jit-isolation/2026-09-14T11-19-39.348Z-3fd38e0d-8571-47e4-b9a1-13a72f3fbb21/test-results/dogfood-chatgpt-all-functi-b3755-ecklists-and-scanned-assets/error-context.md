...
- generic [ref=e1]:
      ...
      - banner [ref=e41]:
        ...
        - generic [ref=e65]:
          ...
          - button "打开账号信息" [ref=e69] [cursor=pointer]:
            ...
            - strong [ref=e72] [cursor=pointer]: ops-fixture-actor-e13f33e0-edc6-43c2-86c1-f5071a8fc4df
        ...
        - region "客户交付" [ref=e78]:
          - generic [ref=e79]:
            ...
            - generic [ref=e90]:
              ...
              - generic [ref=e95]:
                - generic [ref=e97]:
                  - generic "ws_ops_fixture_e13f33e0edc643c286c1f5071a8fc4df" [ref=e98]:
                    - text: ws_ops_fixture_e13f33e0edc643c286c1f5071a8fc4df
            ...
            - generic [ref=e124]:
              ...
              - generic [ref=e135]:
                ...
                - table [ref=e150]:
                  ...
                  - rowgroup [ref=e164]:
                    - row "01 隔离交付验收-1789384905335 未填写 未填写 未填写 未完成 凭证 未上传 尚未完成 0 0/5" [ref=e165]:
                      - cell "01" [ref=e166]
                      - cell "隔离交付验收-1789384905335" [ref=e167]:
                        - strong [ref=e169]: 隔离交付验收-1789384905335
                      - cell "未填写" [ref=e170]:
  ...
  - dialog "隔离交付验收-1789384905335 · 客户档案" [ref=e204]:
    - generic [ref=e206]:
      - button "关闭" [ref=e207] [cursor=pointer]:
        - img "close" [ref=e208] [cursor=pointer]:
          - img [ref=e209] [cursor=pointer]
      - generic [ref=e211]: 隔离交付验收-1789384905335 · 客户档案
    - generic [ref=e215]:
      - generic [ref=e217]:
        - generic "公司名称" [ref=e219]: "* 公司名称"
        - textbox "* 公司名称" [ref=e223]: 隔离交付验收-1789384905335
      - generic [ref=e225]:
        - generic "合同编号" [ref=e227]: "* 合同编号"
        - textbox "* 合同编号" [ref=e231]: C-1789384910195
      - generic [ref=e233]:
      ...
      - generic [ref=e276]:
        ...
        - textbox "* 合同文件" [ref=e282]: asset_ref_missing_contract
      - generic [ref=e283]:
        - button "上传合同文件" [ref=e286] [cursor=pointer]:
          - generic [ref=e287] [cursor=pointer]: 上传合同文件
        - generic [ref=e288]: PDF、DOCX、PNG、JPG、JPEG；单文件不超过 50 MiB。安全检查通过后填入素材编号，保存当前环节后才会登记。
        - status
      - generic [ref=e289]: 素材编号须通过服务端安全核验；HTTPS 链接作为外部合同凭证保存，不代表已完成平台扫描。
      - generic [ref=e291]:
        - generic "项目负责人" [ref=e293]: "* 项目负责人"
        - textbox "* 项目负责人" [ref=e297]: 隔离项目负责人
      - generic [ref=e299]:
        - generic "售后负责人" [ref=e301]: "* 售后负责人"
        - textbox "* 售后负责人" [ref=e305]: 隔离售后负责人
      - generic [ref=e307]:
        - generic "要求上线时间" [ref=e309]: "* 要求上线时间"
        - textbox "* 要求上线时间" [ref=e313]: 2026-10-01T09:00
      - button "保存当前环节" [active] [ref=e314] [cursor=pointer]:
        - generic [ref=e315] [cursor=pointer]: 保存当前环节
```
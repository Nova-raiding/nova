    ...
    - main [ref=e123]:
      ...
      - status [ref=e125]:
        ...
        - generic [ref=e130]:
          ...
          - generic [ref=e132]: 部分数据集刷新失败（ops.stores.list、ops.storage.reconciliation.list、ops.marketing.summary、ops.brand-units.summary、ops.audit.platform.list、ops.tasks.summary、ops.alerts.list、ops.growth.funnel、ops.workspaces.list）。页面保留上次成功数据，这些值可能已过期：当前账号没有访问部分运营数据的权限；请切换具备对应角色的运营账号。
        ...
        - generic [ref=e148]:
          - alert [ref=e151]:
            ...
            - generic [ref=e156]:
              ...
              - paragraph [ref=e160]: 部分数据集刷新失败（ops.stores.list、ops.storage.reconciliation.list、ops.marketing.summary、ops.brand-units.summary、ops.audit.platform.list、ops.tasks.summary、ops.alerts.list、ops.growth.funnel、ops.workspaces.list）。页面保留上次成功数据，这些值可能已过期：当前账号没有访问部分运营数据的权限；请切换具备对应角色的运营账号。

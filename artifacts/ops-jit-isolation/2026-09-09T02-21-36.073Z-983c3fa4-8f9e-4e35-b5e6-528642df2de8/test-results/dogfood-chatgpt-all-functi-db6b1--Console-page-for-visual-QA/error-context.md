    ...
    - generic [ref=e8]:
      ...
      - region "当前操作范围" [ref=e15]:
        - generic [ref=e16]:
          ...
          - generic [ref=e18]: 工作区
        - status [ref=e19]: 正在操作工作区 ws_ops_fixture_bdf6e52596f148ab8fde6b3f31980578
        - generic [ref=e20]:
          - generic [ref=e21]: 工作区范围
          - strong [ref=e22]: ws_ops_fixture_bdf6e52596f148ab8fde6b3f31980578
      ...
      - generic [ref=e74]:
        ...
        - region "当前身份与权限范围" [ref=e76]:
          - generic [ref=e77]:
            ...
            - generic [ref=e88]: 身份 ops-fixture-target-bdf6e525-96f1-48ab-8fde-6b3f31980578
            - generic [ref=e90]: 商家工作区
            - generic [ref=e92]: 工作区 · ws_ops_fixture_bdf6e52596f148ab8fde6b3f31980578
    ...
    - main [ref=e100]:
      ...
      - status [ref=e102]:
        ...
        - generic [ref=e107]:
          ...
          - generic [ref=e109]: 部分数据集刷新失败（workspace.commercial.get、billing.model-usage.statement、workspace.metrics、knowledge.rule.list、knowledge.brand.preference.get、knowledge.asset.list、knowledge.learning.list、knowledge.competitor.list、automation.policy.get、automation.policy.list）。页面保留上次成功数据，这些值可能已过期：商业操作尚未满足上线门禁，已拒绝执行
      - generic [ref=e110]:
        - img "Unauthorized" [ref=e112]
        - heading "无权访问“客服”" [active] [level=1] [ref=e167]
        - generic [ref=e169]: 当前会话在workspace:ws_ops_fixture_bdf6e52596f148ab8fde6b3f31980578范围内缺少 support.ticket.read 能力；服务端仍会独立校验每个请求。
        - generic [ref=e171]:
        ...
        - alert "权限拒绝详情" [ref=e182]:
          ...
          - generic [ref=e187]:
            - text: 当前范围：
            - code [ref=e189]: workspace:ws_ops_fixture_bdf6e52596f148ab8fde6b3f31980578
```
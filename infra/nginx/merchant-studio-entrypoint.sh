...
MERCHANT_API_TOKEN="$MERCHANT_API_TOKEN" MERCHANT_WORKSPACE_ID="$MERCHANT_WORKSPACE_ID" MERCHANT_API_RESOLVER="$MERCHANT_API_RESOLVER" \
  envsubst '${MERCHANT_API_TOKEN} ${MERCHANT_WORKSPACE_ID} ${MERCHANT_API_RESOLVER}' \

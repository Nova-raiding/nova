...
export const PROTECTED_OPS_PATHS = Object.freeze([
  ...
  'infra/scripts/apply-migrations.sh', 'infra/scripts/verify-runtime-db-role.sh', 'infra/scripts/generate-container-source-manifest.mjs', 'infra/local/ensure-app-role.sql', 'infra/scripts/pilot-compose-preflight.sh', 'infra/scripts/stage-verified-ecs-release.sh', 'infra/scripts/deploy-verified-ecs-compose.sh', 'infra/scripts/ecs-compose-published-ports.mjs', 'infra/scripts/ecs-compose-published-ports.d.mts', 'infra/scripts/deploy-preflight-ecs.sh', 'infra/scripts/deploy-preflight.sh', 'infra/scripts/check-mcp-integration-production.mjs',
])

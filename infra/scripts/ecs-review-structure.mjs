...
export const PROTECTED_OPS_PATHS = Object.freeze([
  ...
  'infra/scripts/render-ecs-production-compose.sh', 'infra/scripts/validate-ecs-production-compose.mjs', 'infra/scripts/validate-production-config.sh', 'infra/scripts/validate-production-config-yaml.rb',
  'apps/api/src/aliyun-ecs-role-credentials.ts',
  'infra/scripts/apply-migrations.sh', 'infra/scripts/verify-runtime-db-role.sh', 'infra/scripts/generate-container-source-manifest.mjs', 'infra/local/ensure-app-role.sql', 'infra/scripts/pilot-compose-preflight.sh', 'infra/scripts/stage-verified-ecs-release.sh', 'infra/scripts/deploy-verified-ecs-compose.sh', 'infra/scripts/deploy-preflight-ecs.sh', 'infra/scripts/deploy-preflight.sh',
])

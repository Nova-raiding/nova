...
tar -cf - infra/scripts/install-ecs-release-controls.mjs infra/scripts/verify-ecs-bridge-control-install.mjs infra/protected/ecs-preidentity-recovery.mjs tests/ecs-release-control-installer.container-check.mjs |

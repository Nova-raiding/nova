...
WORKLOAD_SECRET_KEYS = {
  'merchant-api' => {
    'merchant-runtime-secrets' => %w[
      DATABASE_URL OPS_DATABASE_URL REDIS_URL API_AUTH_TOKENS MCP_OAUTH_CLIENTS
      OIDC_PROXY_SIGNING_SECRET SESSION_ID_HASH_SECRET
      WORKER_API_CREDENTIALS
      ASSET_DISPLAY_URL_SIGNING_SECRET ASSET_DISPLAY_URL_PREVIOUS_KEYS_JSON VAULT_TOKEN RULE_APPROVAL_TOKENS

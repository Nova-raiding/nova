...
- 产品与目标边界：`doc/PRD-merchant-marketing-codex-final.md`
- 技术方案与生产门禁：`doc/technical-solution-design.md`
- 9 人架构与交付计划：`doc/architecture-and-delivery-plan-9-fte.md`
- 云资源与部署基线：`doc/todo/infra/cloud-resources-and-deployment.md`
- 可视化架构图：`doc/diagrams/merchant-system-architecture.html`

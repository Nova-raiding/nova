...
- 主 PRD：`doc/PRD-merchant-marketing-codex-final.md`，新增 FR-17.6–FR-17.12。
- 目标架构：`doc/ops-console-architecture.md`。
- 架构图：`doc/diagrams/ops-console-architecture.html`。
- 运行手册：`doc/ops-console-runbook.md`。
- 对外架构与能力矩阵：`doc/sales-architecture-and-capability-overview.md`。
- 实现状态和 FR-16 证据：`doc/todo/quality/implementation-status.md`、`doc/fr16-knowledge-context-evidence.md`。
